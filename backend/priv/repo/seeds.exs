...
images_url = "#{BackendWeb.Endpoint.url()}/images"

%Place{
  name: "Sand Castle",
  slug: "sand-castle",
  description: "Build endless sand castles in you front yard",
  location: "Portugal",
  max_guests: 2,
  pet_friendly: false,
  pool: false,
  ...
  image_thumbnail: "#{images_url}/sand-castle-thumb",
  bookings: [
    %Booking{
      start_date: ~D[2019-10-18],
      end_date: ~D[2019-10-21],
      total_price: Decimal.from_float(505.00),
      user: mike
    }
  ]
}
...
%Place{
  name: "Dock House",
  slug: "dock-house",
  description: "Escape to implicity...",
  ...
  reviews: [
    %Review{
      comment: "A little piece of heacen! (WET)",
      rating: 5,
      user: mike,
